...
public class GameEngine {
    ...
    * Countdown(String message, int number), simply counts down starting from given integer to 0 and displays a message*/
    ...
    //Comment from here down out if using in games other than Number Guessing Game


    //Number Guessing Game Specific Functions
    /*EXPERIMENTAL STUFF
    ...
    * Example: if(GameEngine.expCoinflip()){Player1 goes first} else if(!GameEngine.expCoinflip()){Player2 goes first*/
    ...
    public static void randomIntro(){
        int message = GameEngine.getRandom(1,3);//make sure max=highest case #
        switch (message){
            case 1: System.out.print(" ____ ____ ____ ____ ____ ____           \n" +
                    "||N |||U |||M |||B |||3 |||R ||          \n" +
                    "||__|||__|||__|||__|||__|||__||          \n" +
                    "|/__\\|/__\\|/__\\|/__\\|/__\\|/__\\|          \n" +
                    ...
                    "||G |||4 |||M |||3 |||       ||          \n" +
                    "||__|||__|||__|||__|||_______||          \n" +
                    "|/__\\|/__\\|/__\\|/__\\|/_______\\|");System.out.println();break;

            case 2: System.out.print("  _   _ _   _ __  __ ____ _____ ____        \n" +
                    " | \\ | | | | |  \\/  | __ )___ /|  _ \\       \n" +
                    " |  \\| | | | | |\\/| |  _ \\ |_ \\| |_) |      \n" +
                    " | |\\  | |_| | |  | | |_) |__) |  _ <       \n" +
                    " |_| \\_|\\___/|_|  |_|____/____/|_| \\_\\      \n" +
                    "   ____ _   _ _________ ____  _ _   _  ____ \n" +
                    "  / ___| | | |___ / ___| ___|/ | \\ | |/ ___|\n" +
                    " | |  _| | | | |_ \\___ \\___ \\| |  \\| | |  _ \n" +
                    " | |_| | |_| |___) |__) |__) | | |\\  | |_| |\n" +
                    ...
                    " | |  _| || |_| |\\/| | |_ \\                 \n" +
                    " | |_| |__   _| |  | |___) |                \n" +
                    "  \\____|  |_| |_|  |_|____/    ");System.out.println();break;
    ...
    /*This is the ENHANCED coin-flip
    * This will be used for testing before being moved into the actual game engine. big test here
    * TEST: Successful. Awaiting move into actual game engine */
    public static int enhCoinflip(Player p1, Player p2){
        int winner=0; //1 if p1 wins, 2 if p2 wins.
        arrow = "---";
        System.out.printf("%s "+ arrow + " %s\n", p1.getName(),p2.getName());
        GameEngine.delay(1);
        GameEngine.clear();
        int count = GameEngine.getRandom(20,30);
        for(int i=0;i<count;i++){
