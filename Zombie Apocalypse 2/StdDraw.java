...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    // default font
    private static String defaultFontName="Impact";
    private static int defaultFontSize = 16;
    private static Font DEFAULT_FONT = new Font(defaultFontName, Font.PLAIN, defaultFontSize);
    private static Font WELCOME_FONT = new Font("MONOSPACED", Font.PLAIN, 32);
    ...
    public static void setDefaultFont(int choice ){
        if(choice==1){
    ...
    private static void init() {
        ...
        frame.setTitle("Zombie Apocalypse 2");
    ...
    private static JMenuBar createMenuBar() {
        ...
        JMenuItem cheatItem = new JMenuItem("Ctrl+Shift+C to activate cheat menu");

        cheatItem.addActionListener(std);
    ...
    *************************************************************************/
     ...
     */
    public static void clear() { clear(DEFAULT_PEN_COLOR); }
    /**
